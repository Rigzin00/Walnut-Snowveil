...
const AnimatedCounter = ({ target, suffix, label }: { target: number, suffix: string, label: string }) => {
  ...
  return (
    <div ref={ref} className="flex flex-col items-center justify-center w-full md:w-1/3 py-[40px] md:py-0">
      <div className="flex flex-row items-start text-[#5c3115]">
        ...
        <span 
          className="text-[30px] md:text-[40px] leading-none tracking-tight pt-2 md:pt-3 ml-1"
          style={{ fontFamily: "Jomolhari, 'Playfair Display', Georgia, serif" }}
        >
          {suffix}
        </span>
