...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-10 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
